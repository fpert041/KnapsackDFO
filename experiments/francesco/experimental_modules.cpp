//
//  experimental_modules.cpp
//  imgSymmetry
//
//  Created by Francesco Perticarari on 13/12/2017.
//

#include "experimental_modules.hpp"
...
DFOx::DFOx(std::function<double(std::vector<double>)> fitnessFunc) : Utilis(fitnessFunc){}
...
void const DFOx::setConstrainPos(bool status){
...
void const DFOx::generateSwarmPositiveAxis(){
...
/*********************************************************************************
 *
 * DFOx equation implementation: evaluate flies, make them interact & update the swarm
 * - Call this method when you want to run a cycle of the algorithm -
 *
 *********************************************************************************/

void const DFOx::updateSwarm(){
